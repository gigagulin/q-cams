...
n_counter,n_unitary=8,6
N=n_counter+n_unitary						# number of qubit
initial_a=np.array([0.5]*n_counter+[0.5,0.5,0.5,0.5,0.5,0.5],dtype='float')# initial set
...
def qproc(bf):
	...
	c.h[ga5]
	q.ccccccx(c,bf,ga0,ga1,ga2,ga3,ga4,ga5)
	c.h[ga5]
	...
	c.cx[bf,ga5].ry(-np.pi/4)[ga5].cx[bf,ga5].ry(np.pi/4)[ga5].cx[bf,ga5]
	c.cx[bf,ga0].cx[bf,ga1].cx[bf,ga2].cx[bf,ga3].cx[bf,ga4].cx[bf,ga5]
